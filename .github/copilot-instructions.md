...
- **NEVER use em-dashes (Unicode U+2014) anywhere in scripts, configs, comments, strings, or output. Use `-` or `--` only. Em-dashes break PowerShell 5.1 and ASCII-dependent tooling. This rule is absolute.**
