...
class _Conn(Protocol):
    ...
    # sqlite3.Connection is itself a context manager: entering returns the
    # connection and exiting commits on success or rolls back on exception.
    # The migration runner relies on this for its single-transaction guarantee.
